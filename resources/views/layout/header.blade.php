<nav class="navbar sticky-top bg-light navbar-expand-lg navbar-light py-4 shadow-sm">
  <div class="container">
    <a class="navbar-brand" href="/">
      <img class="img-fluid" src="{{ asset('bootstrap5-plain-assets/logos/plainb-logo.svg') }}" alt="Logo" width="96px">
    </a>
